...
Este readme contiene los pasos necesarios para clonar el repositorio de Aerostack2 y sobre el que se han desarrollado los paquetes necesarios para el correcto cumplimiento de los requisitos de este proyecto.
