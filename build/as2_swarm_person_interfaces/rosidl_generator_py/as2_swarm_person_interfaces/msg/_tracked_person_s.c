...
bool as2_swarm_person_interfaces__msg__tracked_person__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("as2_swarm_person_interfaces.msg._tracked_person.TrackedPerson", full_classname_dest, 61) == 0);
  }
  as2_swarm_person_interfaces__msg__TrackedPerson * ros_message = _ros_message;
  {  // header
...
PyObject * as2_swarm_person_interfaces__msg__tracked_person__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("as2_swarm_person_interfaces.msg._tracked_person");
