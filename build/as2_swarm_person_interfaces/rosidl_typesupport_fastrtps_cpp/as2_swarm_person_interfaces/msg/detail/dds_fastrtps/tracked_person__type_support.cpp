...
#include "as2_swarm_person_interfaces/msg/detail/tracked_person__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const as2_swarm_person_interfaces::msg::TrackedPerson & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  as2_swarm_person_interfaces::msg::TrackedPerson & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = as2_swarm_person_interfaces::msg::TrackedPerson;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const as2_swarm_person_interfaces::msg::TrackedPerson *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<as2_swarm_person_interfaces::msg::TrackedPerson *>(
    untyped_ros_message);
...
{
  return &as2_swarm_person_interfaces::msg::typesupport_fastrtps_cpp::_TrackedPerson__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, as2_swarm_person_interfaces, msg, TrackedPerson)() {
  return &as2_swarm_person_interfaces::msg::typesupport_fastrtps_cpp::_TrackedPerson__handle;
}
