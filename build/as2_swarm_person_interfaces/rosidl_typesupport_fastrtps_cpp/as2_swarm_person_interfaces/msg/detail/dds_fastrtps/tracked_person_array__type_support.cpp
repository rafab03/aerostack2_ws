...
#include "as2_swarm_person_interfaces/msg/detail/tracked_person_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const as2_swarm_person_interfaces::msg::TrackedPerson &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  as2_swarm_person_interfaces::msg::TrackedPerson &);
size_t get_serialized_size(
  const as2_swarm_person_interfaces::msg::TrackedPerson &,
  size_t current_alignment);
size_t
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: persons
  {
    ...
    for (size_t i = 0; i < size; i++) {
      as2_swarm_person_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
  ...
  as2_swarm_person_interfaces::msg::TrackedPersonArray & ros_message)
{
  ...
  // Member: persons
  {
    ...
    for (size_t i = 0; i < size; i++) {
      as2_swarm_person_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: persons
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        as2_swarm_person_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: persons
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        as2_swarm_person_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_TrackedPerson(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = as2_swarm_person_interfaces::msg::TrackedPersonArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const as2_swarm_person_interfaces::msg::TrackedPersonArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<as2_swarm_person_interfaces::msg::TrackedPersonArray *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TrackedPersonArray__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const as2_swarm_person_interfaces::msg::TrackedPersonArray *>(
...
static size_t _TrackedPersonArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TrackedPersonArray(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TrackedPersonArray__callbacks = {
...
static rosidl_message_type_support_t _TrackedPersonArray__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TrackedPersonArray__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_as2_swarm_person_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<as2_swarm_person_interfaces::msg::TrackedPersonArray>()
{
  return &as2_swarm_person_interfaces::msg::typesupport_fastrtps_cpp::_TrackedPersonArray__handle;
}
