...
#include "as2_swarm_person_interfaces/msg/detail/tracked_person__rosidl_typesupport_fastrtps_c.h"
...
using _TrackedPerson__ros_msg_type = as2_swarm_person_interfaces__msg__TrackedPerson;
...
static uint32_t _TrackedPerson__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_as2_swarm_person_interfaces__msg__TrackedPerson(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = as2_swarm_person_interfaces__msg__TrackedPerson;
    is_plain =
      (
...
static size_t _TrackedPerson__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_as2_swarm_person_interfaces__msg__TrackedPerson(
