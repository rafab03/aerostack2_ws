...
static const _TrackedPersonArray_type_support_symbol_names_t _TrackedPersonArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, as2_swarm_person_interfaces, msg, TrackedPersonArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, as2_swarm_person_interfaces, msg, TrackedPersonArray)),
  }
};
...
{
  return &::as2_swarm_person_interfaces::msg::rosidl_typesupport_cpp::TrackedPersonArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, as2_swarm_person_interfaces, msg, TrackedPersonArray)() {
  return get_message_type_support_handle<as2_swarm_person_interfaces::msg::TrackedPersonArray>();
}
