...
bool as2_msgs__msg__pose_with_id_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("as2_msgs.msg._pose_with_id_array.PoseWithIDArray", full_classname_dest, 48) == 0);
  }
  as2_msgs__msg__PoseWithIDArray * ros_message = _ros_message;
  {  // poses
    ...
    as2_msgs__msg__PoseWithID * dest = ros_message->poses.data;
...
{
  /* NOTE(esteve): Call constructor of PoseWithIDArray */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("as2_msgs.msg._pose_with_id_array");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PoseWithIDArray");
