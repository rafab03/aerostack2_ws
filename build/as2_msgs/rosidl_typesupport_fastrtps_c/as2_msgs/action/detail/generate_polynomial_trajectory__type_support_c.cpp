...
#include "as2_msgs/msg/detail/pose_stamped_with_id__functions.h"  // path
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: path
  {
    ...
    if (ros_message->path.data) {
      as2_msgs__msg__PoseStampedWithID__Sequence__fini(&ros_message->path);
    }
    if (!as2_msgs__msg__PoseStampedWithID__Sequence__init(&ros_message->path, size)) {
