...
bool as2_msgs__msg__u_int16_multi_array_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("as2_msgs.msg._u_int16_multi_array_stamped.UInt16MultiArrayStamped", full_classname_dest, 65) == 0);
  }
  as2_msgs__msg__UInt16MultiArrayStamped * ros_message = _ros_message;
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of UInt16MultiArrayStamped */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("as2_msgs.msg._u_int16_multi_array_stamped");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UInt16MultiArrayStamped");
