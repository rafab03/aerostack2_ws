...
static const _ModifySwarm_Request_type_support_symbol_names_t _ModifySwarm_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, as2_msgs, srv, ModifySwarm_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, as2_msgs, srv, ModifySwarm_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, as2_msgs, srv, ModifySwarm_Request)() {
  return &::as2_msgs::srv::rosidl_typesupport_c::ModifySwarm_Request_message_type_support_handle;
}
...
static const _ModifySwarm_Response_type_support_symbol_names_t _ModifySwarm_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, as2_msgs, srv, ModifySwarm_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, as2_msgs, srv, ModifySwarm_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, as2_msgs, srv, ModifySwarm_Response)() {
  return &::as2_msgs::srv::rosidl_typesupport_c::ModifySwarm_Response_message_type_support_handle;
}
...
static const _ModifySwarm_type_support_symbol_names_t _ModifySwarm_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, as2_msgs, srv, ModifySwarm)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, as2_msgs, srv, ModifySwarm)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, as2_msgs, srv, ModifySwarm)() {
  return &::as2_msgs::srv::rosidl_typesupport_c::ModifySwarm_service_type_support_handle;
}
